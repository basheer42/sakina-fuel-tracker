...
EMAIL_PROCESSING_PORT = config('EMAIL_PROCESSING_PORT', cast=int)
...
# --- SENDER FILTERS ---
EMAIL_STATUS_UPDATE_SENDER_FILTER = config('EMAIL_STATUS_UPDATE_SENDER_FILTER')
EMAIL_BOL_SENDER_FILTER = config('EMAIL_BOL_SENDER_FILTER')